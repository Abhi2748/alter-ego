...
FAQ_ITEMS = [
    ...
    },
    {
        ...
        "a": "Interest missions are generated daily by the Planner, which reads your goal, current arc phase, skill milestone progress, covered skills from past sessions, and any feedback you've given on previous missions. Each interest includes an achievable outcome (what you'll realistically reach in your timeline), an ordered skill roadmap (domain-specific milestones, not session counts), and recommended resources. The Planner remembers what it already taught you and never re-covers a completed skill unless a higher phase demands it. If you miss a session, the next mission re-addresses the same skill rather than advancing. If you rate a mission and add feedback text, that note is used directly in your next mission. Missions also reference specific chapters, videos, or search terms from your recommended resources.",
    },
    {
        "q": "What is a quit path?",
        "a": "A quit path is a structured program for reducing or stopping a habit using Habit Reversal Training (HRT). It runs in three automatic phases: Trigger Mapping (observe and log when and why the habit occurs — no behaviour change yet), Competing Response (practice a replacement behaviour that intercepts the trigger), and Consolidation (make the competing response automatic in high-risk situations). You progress between phases automatically when readiness criteria are met — you don't advance manually. Resistance missions are generated daily and calibrated to your current phase, triggers, and competing response. The system also uses any personal context notes you write about your habit. Log honestly — the system is built for real data, not perfection.",
    },
    {
        "q": "How does the Focus timer work?",
        "a": "The Focus tab has three modes — Pomodoro (25/5/15 minute cycles, configurable rounds), Deep Work (30–120 minute single countdown), and Stopwatch (count-up, no target). Sessions are optionally tagged by topic. Every completed session earns Focus SP up to your daily cap. Your weekly report includes a focus summary: total minutes, sessions, and your most-used tag for the week. Your stats, weekly chart, and session history are in the Stats sub-tab.",
    },
    {
        "q": "How is my weekly report generated?",
        "a": "Your weekly report covers Sunday through Saturday and is generated every Sunday at 3 AM in your local timezone by an AI agent. It reviews your full week: mission completion, Twin gap movement, streak status, focus sessions logged, interest arc progress, and quit path phase. The report appears in the Report tab. Your first report arrives after your first full Sun–Sat week.",
    },
]
