...
FAQ_ITEMS = [
    ...
    },
    {
        ...
        "a": "Interest missions are generated by the Planner from your declared goal, current level, timeline, and active practice days. Each interest now includes an achievable outcome, ordered skill milestones, and recommended resources. Daily missions target your current milestone, track covered skills after completion, and adapt using your ratings + feedback text (for example, \"too hard\" or \"too easy\") so the next mission is calibrated to your real progress.",
    },
    {
