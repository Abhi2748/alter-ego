...
export function OnboardingFramingScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.bg1, alignItems: "center", justifyContent: "center", paddingHorizontal: 24 }}>
      <Text style={{ color: COLORS.text, fontSize: 20, fontWeight: "700", marginBottom: 16 }}>Onboarding Framing</Text>
      <Pressable
        onPress={() => navigation.navigate("OnboardingQuestion", { questionNumber: 1 })}
